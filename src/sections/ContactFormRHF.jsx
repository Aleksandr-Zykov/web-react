  ...
  return (
    <form className="contact-form" onSubmit={handleSubmit(onValid, onInvalid)} noValidate>
      <div className="contact-form__item">
        <label htmlFor="rhf-name" className="contact-form__label">
          ПІБ
        </label>
        <input
          id="rhf-name"
      ...
      <div className="contact-form__item">
        <label htmlFor="rhf-email" className="contact-form__label">
          Email
        </label>
        <input
          id="rhf-email"
      ...
      <div className="contact-form__item">
        <label htmlFor="rhf-msg" className="contact-form__label">
          Повідомлення
        </label>
        <textarea
          id="rhf-msg"
